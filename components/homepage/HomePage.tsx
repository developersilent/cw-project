...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-[100dvh] overflow-hidden bg-white/50 max-sm:bg-white/80 select-none">
      <main className="flex-1">
        <section
          id="home"
          className="w-full pt-10 max-sm:py-5 grid place-content-center"
        >
              ...
              <RevealAnimationWithXFromLeft>
                <div id="dog">
                  <Image
                    ...
                    className="mx-auto object-center scale-105 pointer-events-none"
                  />
                </div>
              </RevealAnimationWithXFromLeft>
              <div className="flex flex-col gap-3 justify-center sm:mt-5 max-sm:mt-7">
                <RevealAnimation>
                  <h1 className="max-sm:text-[33px] bg-white/60 text-[#222831] sm:text-5xl md:text-6xl lg:text-7xl leading-9 font-bold">
                    <TextAnimation text="Courage The Cowardly Dog" />
                  </h1>
                </RevealAnimation>
                <RevealAnimationWithXFromRight>
                  <p className="mx-auto bg-white/50 text-[#092635] text-[19px] max-w-[700px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#f8f8f8]">
          ...
          <div className="container px-4 md:px-6 mt-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2 grid gap-1 bg-white/50">
                <div className="inline-block rounded-lg text-[#2C3333] px-3 py-2 w-full font-semibold text-base">
                  Courage&apos;s Home
                </div>
                <RevealAnimationWithXFromLeft>
                  <h2 className="text-3xl font-bold text-[#333] sm:text-5xl dark:text-[#f8f8f8]">
                    The Middle of Nowhere
                  </h2>
                </RevealAnimationWithXFromLeft>
                <RevealAnimationWithXFromRight>
                  <p className="max-w-[900px] text-[19px] text-[#092635] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#f8f8f8]">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-8 text-center">
              <div className="space-y-2 grid gap-1 place-content-center bg-white/50">
                <div className="inline-block rounded-lg w-full px-3 py-2 text-base font-semibold text-[#1e2b38] dark:bg-gray-600">
                  Courage&apos;s Defenses
                </div>
                <RevealAnimationWithXFromRight>
                  <h2 className="text-3xl font-bold text-[#082032] sm:text-5xl dark:text-gray-100">
                    Protecting Muriel
                  </h2>
                </RevealAnimationWithXFromRight>
                <RevealAnimationWithXFromLeft>
                  <p className="max-w-3xl text-[19px] mx-auto text-[#082032] dark:text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              <div className="grid bg-blend-exclusion bg-white/50 grid-cols-1 pt-24 gap-5 sm:grid-cols-2 md:grid-cols-3">
                ...
                />
                <FeatureCard
                  icon={<IconGhost className="text-slate-600" />}
                ...
                <FeatureCard
                  icon={<IconWindow className="text-blue-400" />}
                ...
                <FeatureCard
                  icon={<IconDatabaseExport className="text-emerald-500" />}
                ...
                <FeatureCard
                  icon={<IconCloudRain className="text-cyan-300" />}
      ...
      <footer className="flex flex-col gap-2  sm:flex-row py-4 w-full shrink-0 items-center px-4 md:px-6 bg-gradient-to-b from-white bg-white/60 dark:bg-[#1e1e1e]">
...
function FeatureCard({
  ...
  return (
    <RevealAnimationWithXFromRight>
      <div className="flex flex-col h-48 items-start space-y-2 rounded-lg bg-[#ffffff] p-6 shadow-sm transition-all hover:scale-105 hover:shadow-md dark:bg-gray-950 dark:hover:bg-gray-800">
        {icon}
